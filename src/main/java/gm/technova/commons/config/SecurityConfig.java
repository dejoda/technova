...
import gm.technova.commons.security.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
    ...
    private final PasswordEncoder passwordEncoder;  // ← inyectar como campo
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/producto-imagenes").hasRole("ADMIN")
                        .requestMatchers("/movimientos-inventario/**", "/movimientos-inventario").permitAll()
